...
{
    /// <summary>
    ///     Class to construct product related information for a Google Analytics hit. Use this class to report information
    ///     about products sold by merchants or impressions of products seen by users. Instances of this class can be
    ///     associated with both <see cref="ProductAction" />s via addProduct(Product) and Product Impressions via
    ...
    public sealed class Product
    {
        ...
        /// </summary>
        public IDictionary<int, string> CustomDimensions { get; }

        /// <summary>
        ///     Gets or sets the custom metrics associated with the product.
        /// </summary>
        public IDictionary<int, float> CustomMetrics { get; }
