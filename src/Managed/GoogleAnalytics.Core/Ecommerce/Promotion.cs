...
{
    /// <summary>
    ///     Class to construct promotion related fields for Google Analytics hits. The fields from this class can be used to
    ///     represent internal promotions that run within an app, such as banners, banner ads etc.
    /// </summary>
