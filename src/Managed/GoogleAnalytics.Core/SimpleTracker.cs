...
namespace GoogleAnalytics
{
    ...
    public class SimpleTracker
    {
        ...
        /// <summary>
        ///     Gets or sets the value that anonymously identifies a particular user, device, or browser instance. For the web,
        ///     this is generally stored as a first-party cookie with a two-year expiration. For mobile apps, this is randomly
        ///     generated for each particular instance of an application install. The value of this field should be a random UUID
        ///     (version 4) as described in <see href="http://www.ietf.org/rfc/rfc4122.txt" />.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        ///     100 means no items should be excluded, 50 means half should be excluded, and 0 means all items should be
        ///     excluded.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="key">
        ///     The key of the field that needs to be set. It starts with "&amp;" followed by the parameter name. The
        ///     complete list of fields can be found at <see href="https://goo.gl/M6dK2U" />.
        /// </param>
        /// <param name="value">
        ///     A string value to be sent to Google servers. A null value denotes that the value should not be sent
        ///     over wire.
        /// </param>
        ...
        private IDictionary<string, string> AddRequiredHitData(IDictionary<string, string> @params)
        {
            ...
            foreach (var item in _data.Concat(@params)) result[item.Key] = item.Value;
        ...
        /// </summary>
        /// <param name="params">
        ///     Dictionary of hit data to values which are merged with the existing values which are already set
        ///     (using Set(String, String)). Values in this dictionary will override the values set earlier. The values in this
        ///     dictionary will not be reused for the subsequent hits. If you need to send a value in multiple hits, you can use
        ///     the Set(String, String) method.
        /// </param>
        ...
        public void Send(IDictionary<string, string> @params)
        {
            ...
            if (!IsSampledOut()) _serviceManager.EnqueueHit(AddRequiredHitData(@params));
        }

        private bool IsSampledOut()
        {
            if (SampleRate <= 0.0F) return true;
        ...
        /// <summary>
        ///     Gets or sets the tracking ID / web property ID. The format is UA-XXXX-Y. All collected data is associated by this
        ///     ID.
        /// </summary>
        /// <remarks>Required for all hit types.</remarks>
        ...
        /// <summary>
        ///     Gets or sets the data source of the hit. Hits sent from analytics.js will have data source set to 'web'; hits sent
        ...
        /// <summary>
        ///     Gets or sets the IP address of the user. This should be a valid IP address in IPv4 or IPv6 format. It will always
        ///     be anonymized just as though anonymize IP had been used.
        /// </summary>
        /// <remarks>Optional.</remarks>
        ...
        /// <summary>
        ///     Gets or sets the User Agent of the browser. Note that Google has libraries to identify real user agents. Hand
        ...
        /// <summary>
        ///     Gets or sets the geographical location of the user. The geographical ID should be a two letter country code or a
        ...
        /// <summary>
        ///     Gets or sets the 'Screen Name' of the screenview hit. On web properties this will default to the unique URL of the
        ///     page.
        /// </summary>
        /// <remarks>
        ///     Required for screenview hit type. Note: This parameter is optional on web properties, and required on mobile
        ///     properties for screenview hits.
        /// </remarks>
        ...
        /// <summary>
        ///     Gets or sets the application name. This field is required for any hit that has app related data (i.e., app version,
        ...
        /// <summary>
        ///     Gets or sets the parameter that specifies that this user has been exposed to an experiment with the given ID. It
        ///     should be sent in conjunction with the Experiment Variant parameter.
        /// </summary>
        /// <remarks>Optional.</remarks>
        ...
        /// <summary>
        ///     Gets or sets the parameter that specifies that this user has been exposed to a particular variation of an
        ///     experiment. It should be sent in conjunction with the Experiment ID parameter.
        /// </summary>
        /// <remarks>Optional.</remarks>
